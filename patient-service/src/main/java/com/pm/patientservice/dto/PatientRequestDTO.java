...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Registered date is required") @Size(max = 10, message = "Registered date can not exceed 10 characters") String getRegisteredDate() {
        return registeredDate;
    }

    public void setRegisteredDate(@NotBlank(message = "Registered date is required") @Size(max = 10, message = "Registered date can not exceed 10 characters") String registeredDate) {
